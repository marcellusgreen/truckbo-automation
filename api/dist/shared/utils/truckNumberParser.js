...
exports.truckNumberParser = exports.TruckNumberParser = void 0;
class TruckNumberParser {
    /**
     ...
     */
    parseFromLicensePlate(licensePlate) {
     ...
     */
    parseFromRegistrationNumber(registrationNumber) {
     ...
     */
    parseFromDocumentText(documentText) {
        const results = [];
...
exports.TruckNumberParser = TruckNumberParser;
exports.truckNumberParser = new TruckNumberParser();
