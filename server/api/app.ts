...
app.use('/api/:version', (req, res, next) => {
  ...
  if ((req as any).context) {
    (req as any).context.apiVersion = version;
  }
...
app.get('/api/status', (req, res) => {
  res.json({
    ...
    timestamp: new Date().toISOString(),
    version: 'v1',
    requestId: (req as any).context?.requestId || 'status_check'
  });
});
...
app.get('/api/docs', (req, res) => {
  res.json({
    ...
    timestamp: new Date().toISOString(),
    version: 'v1',
    requestId: (req as any).context?.requestId || 'docs_request'
  });
});
...
app.use('/api/v2/*', (req, res) => {
  res.status(501).json({
    ...
    timestamp: new Date().toISOString(),
    version: 'v2',
    requestId: (req as any).context?.requestId || 'v2_not_implemented',
    error: {
